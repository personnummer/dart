...
void main() {
  ...
  test('should format input values correct', () {
    ...
    expect('198507099805', Personnummer.format('19850709-9805', true));
    expect('198507099813', Personnummer.format('198507099813', true));
  });
  ...
  test('should test sex', () {
    expect(true, Personnummer.isMale(198507099813, false));
    expect(false, Personnummer.isFemale(198507099813, false));
    expect(true, Personnummer.isFemale('850709-9805', false));
    expect(false, Personnummer.isMale('850709-9805', false));
  });
